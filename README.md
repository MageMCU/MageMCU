...
- Any products, services, or videos described on MageMCU Github Account are considered as an unintentional promotion which is purely coincidental and thereby make clear any idea of promotion should be interpreted solely to be intended for the use for educational purposes only...
