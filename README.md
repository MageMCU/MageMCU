...
- Programming: Principles and Practice Using C++, 3rd. Ed. - [(Pearson - Learning. For life.)](https://www.pearson.com/en-us/subject-catalog/p/programmingprinciples-and-practices-using-c/P200000012061/9780138308681)
	...
	- [Support for PPP3](https://www.stroustrup.com/programming_support.html) More information - *the link for the code is broken.*
...
- Please follow the [***Disclaimers***](https://github.com/MageMCU/Carpenter-Software-Disclaimer/blob/main/README.md) and ***Terms*** in each of the repositories including the Disclaimers and Terms by Github.
