...
- Any products, services, or videos described on MageMCU Github Account is considered as an unintentional promotion of any kind which is purely coincidental and is intended solely for the use in the educational purposes only...
