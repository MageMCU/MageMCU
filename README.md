...
- Any products, services, and/or mediums like youtube videos described here on the ***MageMCU Github Account*** are considered unintentional and purely coincidental and thereby to make clear any idea of a promotion should be interpreted solely as intended for the use for educational purposes only...
